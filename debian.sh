...
# Change DocumentRoot to /var/www/html/BitWasp
echo "Setting up Apache2 DocumentRoot.."
if ! grep -q "shop" /etc/apache2/sites-enabled/000-default.conf; then
    sed -i 's#/var/www/html#/var/www/html/BitWasp#' /etc/apache2/sites-enabled/000-default.conf
fi
...
cd /var/www/html
git clone https://github.com/Bit-Wasp/BitWasp
chown www-data:www-data -R /var/www/html/BitWasp
